...
Source0  : https://github.com/paullouisageneau/libjuice/archive/v1.5.4/libjuice-1.5.4.tar.gz
...
%prep
%setup -q -n libjuice-1.5.4
cd %{_builddir}/libjuice-1.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726149290
mkdir -p clr-build
pushd clr-build
