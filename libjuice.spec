...
Source0  : https://github.com/paullouisageneau/libjuice/archive/v1.5.1/libjuice-1.5.1.tar.gz
...
%prep
%setup -q -n libjuice-1.5.1
cd %{_builddir}/libjuice-1.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720052709
mkdir -p clr-build
pushd clr-build
