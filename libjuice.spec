...
Source0  : https://github.com/paullouisageneau/libjuice/archive/v1.5.2/libjuice-1.5.2.tar.gz
...
%prep
%setup -q -n libjuice-1.5.2
cd %{_builddir}/libjuice-1.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722449143
mkdir -p clr-build
pushd clr-build
