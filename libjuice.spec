...
Source0  : https://github.com/paullouisageneau/libjuice/archive/v1.5.8/libjuice-1.5.8.tar.gz
...
%prep
%setup -q -n libjuice-1.5.8
cd %{_builddir}/libjuice-1.5.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736262098
mkdir -p clr-build
pushd clr-build
