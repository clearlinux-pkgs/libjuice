...
Version  : 1.6.0
Release  : 11
URL      : https://github.com/paullouisageneau/libjuice/archive/v1.6.0/libjuice-1.6.0.tar.gz
Source0  : https://github.com/paullouisageneau/libjuice/archive/v1.6.0/libjuice-1.6.0.tar.gz
...
%prep
%setup -q -n libjuice-1.6.0
cd %{_builddir}/libjuice-1.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742910863
mkdir -p clr-build
pushd clr-build
