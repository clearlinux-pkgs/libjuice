...
Version  : 1.5.5
Release  : 6
URL      : https://github.com/paullouisageneau/libjuice/archive/v1.5.5/libjuice-1.5.5.tar.gz
Source0  : https://github.com/paullouisageneau/libjuice/archive/v1.5.5/libjuice-1.5.5.tar.gz
...
%prep
%setup -q -n libjuice-1.5.5
cd %{_builddir}/libjuice-1.5.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729606507
mkdir -p clr-build
pushd clr-build
